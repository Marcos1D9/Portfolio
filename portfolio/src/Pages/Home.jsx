            ...
            <div className="max-w-3xl min-w-3xl md:mx-auto flex-col mb-5 flex gap-10">
                <main className="flex flex-col gap-12">
                    ...
                    <section className="w-full flex flex-col items-center mt-2">
                        ...
                        <header className="flex font-bold text-center underline underline-offset-4 text-4xl text-indigo-400 dark:text-gray-100 mb-12 max-xxxs:pl-3 max-xxs:min-w-full max-xxs:justify-start max-xxs:px-0 items-center gap-3">
                        ...
                        <div className="flex flex-col items-center gap-10">
                            ...
                            <div className="grid gap-10">
                                ...
                                <article className="relative flex flex-col justify-between w-full mt-4 mb-20">
                                    ...
                                    <p className="text-slate-900 dark:text-slate-400 mb-2 mt-2 max-xs:flex max-xs:flex-col max-xs:items-center">{language === 'en' ? '(Must contact Munia for register)' : '(Debe contactar con Munia para registrarse)'}</p>
